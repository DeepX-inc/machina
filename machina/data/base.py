...
class BaseData(object):
    ...
    def set_adv(self, vfunc, gamma, lam, centerize=True):
        all_path_vs = [vfunc(Variable(torch.from_numpy(path['obs']).float(), volatile=True)).data.cpu().numpy() for path in self.paths]
